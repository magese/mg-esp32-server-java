 ...
 */
@Slf4j
public class MgToolCallingManager implements ToolCallingManager {
    ...
    public MgToolCallingManager(ObservationRegistry observationRegistry, ToolCallbackResolver toolCallbackResolver,
    ...
    public ToolExecutionResult executeToolCalls(@NotNull Prompt prompt, @NotNull ChatResponse chatResponse) {
        ...
        AssistantMessage toolCallMessage = new AssistantMessage(Objects.requireNonNull(assistantMessage.getText()), assistantMessage.getMetadata(), List.of(toolCall));

        ToolContext toolContext = buildToolContext(prompt, assistantMessage);

        MgToolCallingManager.InternalToolExecutionResult internalToolExecutionResult = executeToolCall(prompt, toolCallMessage,
                toolContext);
     ...
     */
    private MgToolCallingManager.InternalToolExecutionResult executeToolCall(Prompt prompt, AssistantMessage assistantMessage,
        ...
        return new MgToolCallingManager.InternalToolExecutionResult(new ToolResponseMessage(toolResponses, Map.of()), Boolean.TRUE.equals(returnDirect));
    }
    ...
    public static MgToolCallingManager.Builder builder() {
        return new MgToolCallingManager.Builder();
    }
    ...
    public final static class Builder {
        ...
        public MgToolCallingManager.Builder observationRegistry(ObservationRegistry observationRegistry) {
            this.observationRegistry = observationRegistry;
            return this;
        }

        public MgToolCallingManager.Builder toolCallbackResolver(ToolCallbackResolver toolCallbackResolver) {
            this.toolCallbackResolver = toolCallbackResolver;
            return this;
        }

        public MgToolCallingManager.Builder toolExecutionExceptionProcessor(
                ToolExecutionExceptionProcessor toolExecutionExceptionProcessor) {
            this.toolExecutionExceptionProcessor = toolExecutionExceptionProcessor;
            return this;
        }
