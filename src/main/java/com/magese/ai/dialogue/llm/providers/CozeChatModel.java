...
public class CozeChatModel implements ChatModel {
    ...
    public ChatResponse call(Prompt prompt) {
        CreateChatReq req = buildCreateChatReq(prompt);
        /*
    ...
    public Flux<ChatResponse> stream(Prompt prompt) {
        // 发送请求
        try {
            Flowable<ChatEvent> resp = coze.chat().stream(buildCreateChatReq(prompt));
            // 转换为 Reactor Flux
            ...
            Flux<ChatResponse> chatResponse = flux
                    ...
                    .map(event -> {
                        ...
                        Map<String, Object> messageMetadata = Optional.ofNullable(message)
                                ...
                                .map(metaData -> (Map<String, Object>) new HashMap<String, Object>(metaData))
                                .orElse(new HashMap<>());
    ...
    private CreateChatReq buildCreateChatReq(Prompt prompt) {
