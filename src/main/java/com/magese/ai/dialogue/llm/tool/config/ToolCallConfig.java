package com.magese.ai.dialogue.llm.tool.config;

import com.magese.ai.dialogue.llm.tool.MgToolCallingManager;
...
public class ToolCallConfig {
    ...
    public ToolCallingManager toolCallingManager(ObservationRegistry observationRegistry, ToolCallbackResolver toolCallbackResolver,
        ...
        return new MgToolCallingManager(observationRegistry, toolCallbackResolver,
